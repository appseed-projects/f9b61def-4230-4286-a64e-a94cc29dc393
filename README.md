...
> Built with [App Generator](https://appseed.us/generator/), timestamp `2023-06-19 14:43`
...
```bash
$ # Get the code
$ git clone https://github.com/appseed-projects/f9b61def-4230-4286-a64e-a94cc29dc393.git
$ cd f9b61def-4230-4286-a64e-a94cc29dc393
```
